...
class PeriodsControllerTest < ActionController::TestCase
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post :create, period: { bell_cycle_id: @period.bell_cycle_id, end_time: @period.end_time, name: @period.name, start_time: @period.start_time }
    end
  ...
  test "should update period" do
    patch :update, id: @period, period: { bell_cycle_id: @period.bell_cycle_id, end_time: @period.end_time, name: @period.name, start_time: @period.start_time }
    assert_redirected_to period_path(assigns(:period))
  end
